   ...
   >
      ...
      <v-container fluid class="jello-topbar">
         <div class="d-flex justify-space-between">
            ...
            :style="board.image.downloadURL != '' ? 'color:#fff':''">mdi-menu</v-icon>
            <nuxt-link to="/">
            ...
            <v-icon small @click="deleteBoard()" :style="board.image.downloadURL != '' ? 'color:#fff':''">mdi-delete-outline</v-icon>
         </div>
      </v-container>
      <v-navigation-drawer
         v-model="drawer"
      ...
      <div class="d-flex flex-row justify-space-between">
         <h4 :style="board.image.downloadURL != '' ? 'color:#fff':''">{{ list.title }}</h4>
         <v-icon small @click="deleteList(list.id)" :style="board.image.downloadURL != '' ? 'color:#fff':''">mdi-delete-outline</v-icon>
      </div>
